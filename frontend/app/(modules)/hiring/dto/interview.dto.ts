...
export function mapInterviewFromAPI(apiInterview: InterviewAPI): InterviewUI {
  return {
    id: apiInterview.id,
    candidateName: apiInterview.candidate_name,
    candidateEmail: apiInterview.candidate_email,
    position: apiInterview.position_title,
    positionReqId: apiInterview.position_req_id,
    stage: apiInterview.stage_number,
    stageName: apiInterview.stage_name,
    scheduledDate: apiInterview.scheduled_date,
    scheduledTime: convertTo12Hour(apiInterview.scheduled_time),
    ...
    zoomLink: apiInterview.zoom_link,
